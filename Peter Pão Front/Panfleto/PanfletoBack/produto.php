                ...
                if (isset($_POST['submit'])) {
                    ...
                    if ($nome_produto != null) {
                        if (strcmp($ordem, "Menor preço") == 0) {
                             $query = "SELECT nome_prod, preco_unitario, descricao FROM produto WHERE nome_prod ILIKE '$nome_produto%' AND categoria != 'Mercearia' AND categoria != 'Ingrediente' AND categoria != 'Bebidas' ORDER BY preco_unitario";
                        } else {
                             $query = "SELECT nome_prod, preco_unitario, descricao FROM produto WHERE nome_prod ILIKE '$nome_produto%' AND categoria != 'Mercearia' AND categoria != 'Ingrediente' AND categoria != 'Bebidas' ORDER BY preco_unitario DESC";
                        }
                    } else {
                    ...
                    while($linha = pg_fetch_array($result)) {    
                        ...
                        $preco = "R$ " . money_format('%.2n', $linha['preco_unitario']);
