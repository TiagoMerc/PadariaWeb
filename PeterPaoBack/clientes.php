...
<?php
    ...
    if (isset($_GET["search"])) {
        ...
        if (strcmp($opcao, "Nome") == 0) {
            ...
            $query = "SELECT cpf_cliente, nome_cliente, rua, numero, infrator, telefone_resi, telefone_cel FROM cliente WHERE nome_cliente ILIKE '$consulta'";
    ...
    if(isset($_POST['cadastro'])) {
       if($_POST['cadastro'] == "cliente") {// se é o cadastro de clientes		      
            ...
            $rua = pg_escape_string($rua);
            $numero = pg_escape_string($numero);
            $tel_res = pg_escape_string($tel_res);
      ...
      if (isset($_GET['cliente'])) {
          ...
          $cpf_old = pg_escape_string($cpf_old);
...
<html lang="pt-BR">
    ...
    <body class="row">
           ...
           <div class="containerMenu">
            <table class="imgcontainer">
             ...
             <div class="vertical-menu">
                ...
                <a href="clientes.php" class ="active"> <i class="fa fa-users" style="font-size:24px; padding-right:10px"></i>   Clientes </a>
        ...
        <script>
            function change(x){
               if(x === "consultar"){
                   window.history.pushState(null, null, "clientes.php");
                                    ...
                                    <div id="consultar">
                                        ...
                                        <table id="tabelaConsultar">
                                            ...
                                            <tbody>
                                                ...
                                                {        ?>
                                                <tr>
                                                <td><?php echo mask($obj->cpf_cliente, '###.###.###-##');?></td>
                                                     ...
                                                     <tr>
                                                        <td>
                                                            <label for="tel" class="titulo"> <b>  Telefone Residencial   </b></label>
                                                             <input type="tel" name="tel_res_ins"placeholder="(xx)xxxx-xxxx" maxlength="13" id="tel_add" oninput="tel_replace(this.form.tel_add.value, 'tel_add')" pattern="\([1-9]{2}\)[0-9]{4}-[0-9]{4}" title = "Telefone tem DDD + 8 ou 9 dígitos (Digite apenas números)">   
                                                         </td>
                                                         <td>
                                                   ...
                                                   <tr>
                                                    ...
                                                    <td>
                                                     ...
                                                     <tr>
                                                        <td>
                                                            <label for="tel" class="titulo"> <b>  Telefone Residencial   </b></label>
                                                             <input type="tel" name="tel_res_up"placeholder="(xx)xxxx-xxxx" maxlength="13" id="tel_alt" oninput="tel_replace(this.form.tel_alt.value, 'tel_alt')" pattern="\([1-9]{2}\)[0-9]{4}-[0-9]{4}" title = "Telefone tem DDD + 8 ou 9 dígitos (Digite apenas números)" value="<?php echo $res_cliente; ?>">   
                                                         </td>
                                                         <td>
                                                              <label for="tel" class="titulo"> <b>  Telefone Celular </b></label>
...
<script>
    ...
    function muda_buscaOp(){
        ...
        }else if(opcao.localeCompare("Infrator") == 0){
            $("input[name='search']").remove;
            location.href="clientes.php?search=1&buscaOp=Infrator";
        }
    }
</script>
