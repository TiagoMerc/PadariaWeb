...
<script language="javascript" type="text/javascript">
    ...
    function muda_busca(modo){
        if(modo == 1){
            ...
            switch(opcao){
                ...
                case '3':
                    $("input[name='search_alt']").replaceWith( "<select name= \"search_alt\" onchange=\"consulta_add('2')\" id=\"buscaOp\" onchange=\"consulta_add('1')\"><option value=\"Pães\">Pães</option> <option value=\"Tortas\">Tortas</option> <option value=\"Bolos\">Bolos</option> <option value=\"Doces\">Doces</option> <option value=\"Bebidas\">Bebidas</option> <option value=\"Ingredientes\">Ingredientes</option></select> ");
                    break;
    ...
    function muda_buscaOp(){
        ...
        if(opcao.localeCompare("Código") == 0){
            ...
            $("input[name='search']").replaceWith("<input type=\"text\" placeholder=\"por data (dd/mm/yyyy)..\" maxlength=\"10\" name=\"search\" oninput=\"date_change()\" pattern=\"\\d{2}/\\d{2}/\\d{4}\" title=\"Apenas números. Formato final: dd/mm/yyyy\" required>");
