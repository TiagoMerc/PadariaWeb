...
<?php
    ...
    if (isset($_POST["search"])) {
        ...
        if (strcmp($opcao, "Nome") == 0) {
            $query = "SELECT cpf_funcio, nome_funcio, salario, cargo FROM funcionario WHERE nome_funcio = '$consulta'";
        } else if (strcmp($opcao, "CPF") == 0) {
            $query = "SELECT cpf_funcio, nome_funcio, salario, cargo FROM funcionario WHERE cpf_funcio = '$consulta'";
        } else {
            $query = "SELECT cpf_funcio, nome_funcio, salario, cargo FROM funcionario WHERE cargo = '$consulta'";
        }
    ...
    if(isset($_POST['cadastro'])) {
       if($_POST['cadastro'] == "funcionario") {// se é o cadastro de funcionarios     
            ...
            VALUES ('$cpf', '$nome', $salario, '$cargo', '$senha');";
        ...
        if($_POST['atualizar'] == "funcionario") {
            if (isset($_GET['funcionario'])) {
                ...
                $update = " UPDATE public.funcionario
                            SET cpf_funcio='$cpf', nome_funcio='$nome', salario=$salario, cargo='$cargo', senha='$senha'
           ...
           <div class="containerMenu">
            <table class="imgcontainer">
             ...
             <div class="vertical-menu">
                ...
                <a href="#" class="active" onclick="window.location.replace('funcionarios.php')"> <i class="fa fa-user" style="font-size:24px; padding-right:10px"></i>   Funcionários </a>
                       ...
                       <table id="menuTabela">
                            <tr>
                                ...
                                <td rowspan="7" style = "width: 100%"> 
                                            ...
                                            <tbody>
                                             ...
                                             <?php
                                                ...
                                                <td>
                                                    ...
                                                    <button class= "edit" type="edit" onclick="alter_url(<?php echo $obj->cpf_funcio ?>)" >
                                    ...
                                    <div id="alterar">
                                        <h3>Alterar Dados</h3>
                                        <form onsubmit="change('consultar')" method="post">
                                             <div class="containerBox">
                                                 <table id="formulario">
                                                     <tr>
                                                     <td>
                                            ...
                                            <div class="botoes">
                                                <button type="button" class="voltar" onclick="window.location.replace('funcionarios.php')"><i class="material-icons" style="color:white; font-size: 30pt">keyboard_return</i></button>
